...
Public Class frmMasBillPlace
    ...
    Private Sub LoadData()
        Try
           ...
           "' and CustBranch='" & txtBranch.Text & "' and CustType='BILL'"
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If _IsNew Then
            If Userauthen.IsInsertData = 1 Then
                ...
                Else
                    If CheckCustCode(txtCustCode.Text, txtBranch.Text, "BILL", BillToCustCode, BillToCustBranch) Then
                        MetroFramework.MetroMessageBox.Show(Me, "Billing Code " & txtCustCode.Text & " Branch " & txtBranch.Text & " Already Existing In Database!", "Check Existing", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                        Exit Sub
                    End If
                End If
                SaveBillTo(1)
                'If CheckCustCode(txtCustCode.Text, txtBranch.Text, "BILL", BillToCustCode, BillToCustBranch) = False Then
                '    SaveBillTo(1)
                'Else
                '    MetroFramework.MetroMessageBox.Show(Me, "Billing Code " & txtCustCode.Text & " Branch " & txtBranch.Text & " Already Existing In Database!", "Check Existing", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                '    Exit Sub
    ...
    Private Sub SaveBillTo(_Insert As Integer)
        Try
            ...
            SQLcommand.Append(",'" & BillToCustCode & "'") 'BillToCustcode
            SQLcommand.Append(",'" & BillToCustBranch & "'") ' BillToBranchcode
